...
export default function ListMarque() {
  ...
  async function SendData(e) {
    ...
    try {
      if (Nom === "") {
        flag = false;
        if (Nom === "") {
          setMNom("plesee enter nome marque");
          seterrorNom(false);
        } else {
          setMNom("");
          seterrorNom(true);
      ...
      if (flag) {
        ...
        let res = await axios.post(
          "http://127.0.0.1:8000/api/marque/store",
          formData,
          {
  ...
  const handlDelete = (id) => {
    axios
      .delete("http://127.0.0.1:8000/api/marque/delete/" + id)
      .then((data) => {
        swal("success!", "delete success", "success");
        window.location.pathname = "/marque";
      })
      .catch(({ response }) => {
        ...
        <div class="dash-content">
          <div class="overview">
            <div class="title">
              ...
              <span class="text">les marque</span>
            </div>
          </div>
                    ...
                    <>
                      <tr>
                        ...
                        <td>
                          <div class="d-flex align-items-center">
                            <div class="ms-3">
                              <p class="fw-bold mb-1">{iteam.nom_marque}</p>
                            </div>
                          </div>
                        </td>
                        <td>
                        ...
                        <td>
                          <div className="row">
                            <div className="col-6">
                              <Link
                                to={`/updatemarque/${iteam.id}`}
                                //{`updatemarque/${iteam.id}`}
                                class="btn btn-primary ms-3"
                              >
                                edit
                              </Link>
