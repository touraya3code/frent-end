...
export default function ListDevision() {
  ...
  async function SendData(e) {
    ...
    try {
      if (Nom === "") {
        flag = false;
        if (Nom === "") {
          setMNom("plesee enter nome service");
          seterrorNom(false);
        } else {
          setMNom("");
          seterrorNom(true);
      ...
      if (flag) {
        ...
        let res = await axios.post(
          "http://127.0.0.1:8000/api/divesion/store",
          formData,
          {
  ...
  const handlDelete = (id) => {
    axios
      .delete("http://127.0.0.1:8000/api/divesion/delete/" + id)
      .then((data) => {
        ...
        <div class="dash-content">
          <div class="overview">
            <div class="title">
              ...
              <span class="text">les devision</span>
            </div>
          </div>
